...
module VisModelJS {
    ...
    */
    export class VisualModelPanel {
        ...
        private makeAsFullSizeLayer(element: HTMLElement);
        private makeAsFullSizeLayer(element: SVGElement);
        private makeAsFullSizeLayer(element: any) {
        ...
        constructor(placeHolder: HTMLElement) {
            ...
            this.Viewport = new ViewportManager(this.SVGLayer, this.EventMapLayer, this.ContentLayer);
